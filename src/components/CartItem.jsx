...
function CartItem({item, fromCart, onViewDetails}) {
    const {id, name, imageUrl, price} = item;
  return (
    <div key={id} className='relative group flex flex-col gap-y-2 border border-zinc-200 bg-white rounded-md p-24 cursor-pointer'>
              <div onClick={() => onViewDetails && onViewDetails(id)}>
